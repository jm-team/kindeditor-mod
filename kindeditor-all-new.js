...
(function(window, undefined) {
    ...
    function _inString(val, str, delimiter) {
        ...
        return (delimiter + str + delimiter).indexOf(
                delimiter + val + delimiter) >= 0;
    }
    ...
    function _toMap(val, delimiter) {
        ...
        _each(arr, function(key, val) {
            if ((match = /^(\d+)\.\.(\d+)$/.exec(val))) {
                for (var i = parseInt(match[1], 10); i <=
                parseInt(match[2], 10); i++) {
                    map[i.toString()] = true;
                }
            } else {
                map[val] = true;
        ...
        opacity: function(val) {
            this.each(function() {
                if (this.style.opacity === undefined) {
                    this.style.filter = val == 1 ? '' : 'alpha(opacity=' +
                        (val * 100) + ')';
                } else {
        ...
        function extractNodes(parent, frag) {
            ...
            while (node) {
                ...
                if (incStart >= 0 && incEnd <= 0) {
                    incEnd = testRange.compareBoundaryPoints(_END_TO_END,
                        range);
                }
                if (incEnd >= 0 && end <= 0) {
                    ...
                    if (node.nodeType == 1) {
                        ...
                        if (node == copyRange.startContainer) {
                            textNode = splitTextNode(node,
                                copyRange.startOffset, node.nodeValue.length);
    ...
    _extend(KRange, {
        ...
        setStartAfter: function(node) {
            return this.setStart(node.parentNode || this.doc,
                K(node).index() + 1);
        },
        ...
        setEndAfter: function(node) {
            return this.setEnd(node.parentNode || this.doc,
                K(node).index() + 1);
        },
        ...
        insertNode: function(node) {
            ...
            if (self.compareBoundaryPoints(_END_TO_END,
                    self.cloneRange().setEnd(ec, eo)) >= 1) {
                return self;
            }
    ...
    function _getRng(doc) {
        ...
        if (_IERANGE && (!rng ||
            (!rng.item && rng.parentElement().ownerDocument !== doc))) {
            return null;
        }
        return rng;
    }
    ...
    _extend(KCmd, {
        ...
        commonAncestor: function(tagName) {
            var range = this.range,
                sc = range.startContainer, so = range.startOffset,
                ec = range.endContainer, eo = range.endOffset,
                startNode = (sc.nodeType == 3 || so === 0)
                    ? sc
                    : sc.childNodes[so - 1],
                endNode = (ec.nodeType == 3 || eo === 0)
                    ? ec
                    : ec.childNodes[eo - 1];
        ...
        hilitecolor: function(val) {
            return this.wrap(
                '<span style="background-color:' + val + ';"></span>').select();
        },
    ...
    function _drag(options) {
        var moveEl = options.moveEl,
            ...
            iframeFix = options.iframeFix === undefined
                ? true
                : options.iframeFix;
        var docs = [document];
        if (iframeFix) {
    ...
    _extend(KEdit, KWidget, {
        init: function(options) {
            ...
            var themesPath = _undef(options.themesPath, ''),
                ...
                isDocumentDomain = location.protocol != 'res:' &&
            ...
            iframe.bind('load', function() {
                ...
                try {
                    ...
                    self.options.afterError.call(self, '<!doctype html><html>' +
                        doc.body.parentNode.innerHTML + '</html>');
                }
                if (data) {
    ...
    _extend(KDialog, KWidget, {
        init: function(options) {
            ...
            self.closeIcon = K(
                '<span class="ke-dialog-icon-close" title="' + closeBtn.name +
        ...
        showLoading: function(msg) {
            ...
            self.loading = K(
                ...
                Math.round(body.height() / 3) + 'px;">' + msg + '</div></div>').
                width(body.width()).
                height(body.height()).
    ...
    function _addBookmarkToStack(stack, bookmark) {
        ...
        if (_removeBookmarkTag(bookmark.html) !==
            _removeBookmarkTag(prev.html)) {
            stack.push(bookmark);
        }
    }
    ...
    function _undoToRedo(fromStack, toStack) {
        ...
        if (_removeBookmarkTag(bookmark.html) ===
            _removeBookmarkTag(prev.html) && fromStack.length > 0) {
            prev = fromStack.pop();
        }
        if (edit.designMode) {
            edit.html(prev.html);
    ...
    KEditor.prototype = {
        ...
        create: function() {
            ...
            K.each(self.items, function(i, name) {
                if (name == '|') {
                    ...
                    htmlList.push(
                        '<span class="ke-outline" data-name="' + name +
                        '" title="' + self.lang(name) + '" unselectable="on">');
                    htmlList.push(
                        '<span class="ke-toolbar-icon ke-toolbar-icon-url ke-icon-' +
                        name + '" unselectable="on"></span></span>');
                }
            });
            ...
            var edit = self.edit = _edit({
                ...
                beforeGetHtml: function(html) {
                    ...
                    return _formatHtml(html,
                        self.filterMode ? self.htmlTags : null, self.urlType,
                        self.wellFormatMode, self.indentChar);
                },
                beforeSetHtml: function(html) {
                    html = _formatHtml(html,
                        self.filterMode ? self.htmlTags : null, '', false);
            ...
            statusbar.removeClass('statusbar').
        ...
        text: function(val) {
            var self = this;
            if (val === undefined) {
                return _trim(self.html().
                    replace(/<(?!img|embed).*?>/ig, '').
                    replace(/&nbsp;/ig, ' '));
            } else {
        ...
        addBookmark: function(checkSize) {
            ...
            if (checkSize && self._undoStack.length > 0) {
                ...
                if (Math.abs(
                        html.length - _removeBookmarkTag(prev.html).length) <
                    self.minChangeSize) {
                    return self;
                }
            }
    ...
    function _create(expr, options) {
        ...
        options.themesPath = _undef(options.themesPath,
            options.basePath + 'themes/');
        options.langPath = _undef(options.langPath, options.basePath + 'lang/');
        options.pluginsPath = _undef(options.pluginsPath,
            options.basePath + 'plugins/');
        if (_undef(options.loadStyleMode, K.options.loadStyleMode)) {
            var themeType = _undef(options.themeType, K.options.themeType);
            _loadStyle(options.themesPath + 'default/default.css');
            _loadStyle(
                options.themesPath + themeType + '/' + themeType + '.css');
        }
    ...
    _plugin('core', function(K) {
        ...
        self.clickToolbar('formatblock', function() {
            ...
            _each(blocks, function(key, val) {
                ...
                menu.addItem({
                    title: '<span style="' + style + '" unselectable="on">' +
                    val + '</span>',
            ...
            return html.replace(
                ...
                replace(/(<[^>]*)data-ke-src="([^"]*)"([^>]*>)/ig,
                    function(full, start, src, end) {
                        full = full.replace(/(\s+(?:href|src)=")[^"]*(")/i,
                            function($0, $1, $2) {
        ...
        edit: function() {
            ...
            var dialog = self.createDialog({
                ...
                yesBtn: {
                    name: self.lang('yes'),
                    click: function(e) {
                        self.insertHtml('<a name="' + nameBox.val() + '">').
                            hideDialog().
                            focus();
                    }
                }
...
KindEditor.plugin('autoheight', function(K) {
    ...
    function resetHeight() {
        ...
        self.resize(null,
            Math.max((K.IE ? body.scrollHeight : body.offsetHeight) + 76,
                minHeight));
    }
...
KindEditor.plugin('baidumap', function(K) {
    ...
    self.clickToolbar(name, function() {
                ...
                click: function(e) {
                    ...
                    if (checkbox[0].checked) {
                        self.insertHtml('<iframe src="' + url +
                            '" frameborder="0" style="width:' + (mapWidth + 2) +
                            'px;height:' + (mapHeight + 2) + 'px;"></iframe>');
                    } else {
        ...
        var iframe = K('<iframe class="ke-textarea" frameborder="0" src="' +
            self.pluginsPath + 'baidumap/map.html" style="width:' + mapWidth +
...
KindEditor.plugin('emoticons', function(K) {
    var self = this, name = 'emoticons',
        ...
        allowPreview = self.allowPreviewEmoticons === undefined
            ? true
    ...
    self.clickToolbar(name, function() {
        ...
        if (allowPreview) {
            ...
            previewImg = K(
                '<img class="ke-preview-img" src="' + path + startNum +
                '.gif" />');
        ...
        function bindCellEvent(cell, j, num) {
            ...
            cell.click(function(e) {
                self.insertHtml(
                    '<img src="' + path + num + '.gif" border="0" alt="" />').
                    hideMenu().
                    focus();
                e.stop();
            });
...
KindEditor.plugin('filemanager', function(K) {
    var self = this, name = 'filemanager',
        fileManagerJson = K.undef(self.fileManagerJson,
            self.basePath + 'php/file_manager_json.php'),
        imgPath = self.pluginsPath + name + '/images/',
        lang = self.lang(name + '.');

    function makeFileTitle(filename, filesize, datetime) {
        return filename + ' (' + Math.ceil(filesize / 1024) + 'KB, ' +
            datetime + ')';
    }
    ...
    self.plugin.filemanagerDialog = function(options) {
        ...
        function createList(result) {
            ...
            for (var i = 0, len = fileList.length; i < len; i++) {
                ...
                var iconUrl = imgPath +
                        (data.is_dir ? 'folder-16.gif' : 'file-16.gif'),
                ...
                K(row[0].insertCell(1)).
                    ...
                    html(data.is_dir ? '-' : Math.ceil(data.filesize / 1024) +
                        'KB');
        ...
        function createView(result) {
            ...
            for (var i = 0, len = fileList.length; i < len; i++) {
                ...
                photoDiv.append(img);
                div.append(
                    '<div class="ke-name" title="' + data.filename + '">' +
                    data.filename + '</div>');
            }
        }
    ...
    self.plugin.flash = {
        edit: function() {
            ...
            var dialog = self.createDialog({
                    ...
                    yesBtn: {
                        ...
                        click: function(e) {
                            ...
                            var html = K.mediaImg(
                                self.themesPath + 'common/blank.gif', {
                                    src: url,
            ...
            if (img) {
                ...
                widthBox.val(
                    K.removeUnit(img.css('width')) || attrs.width || 0);
                heightBox.val(
                    K.removeUnit(img.css('height')) || attrs.height || 0);
            }
            urlBox[0].focus();
            urlBox[0].select();
        },
                ...
                yesBtn: {
                    ...
                    click: function(e) {
                        ...
                        if (showLocal && showRemote && tabs &&
                            tabs.selectedIndex === 1 || !showRemote) {
            ...
            afterUpload: function(data) {
                ...
                if (data.error === 0) {
                    ...
                    if (!fillDescAfterUploadImage) {
                        clickFn.call(self, url, data.title, data.width,
...
KindEditor.plugin('insertfile', function(K) {
    ...
    self.clickToolbar(name, function() {
        self.plugin.fileDialog({
            clickFn: function(url, title) {
                var html = '<a class="ke-insertfile" href="' + url +
                    '" data-ke-src="' + url + '" target="_blank">' + title +
                    '</a>';
                self.insertHtml(html).hideDialog().focus();
            }
        });
        ...
        K.each(lang.lineHeight, function(i, row) {
            K.each(row, function(key, val) {
                menu.addItem({
                    ...
                    click: function() {
                        self.cmd.toggle(
                            '<span style="line-height:' + key + ';"></span>', {
        ...
        edit: function() {
            var lang = self.lang(name + '.'),
                html = '<div style="padding:20px;">' +
                    ...
                    '<div class="ke-dialog-row"">' +
                    '<label for="keType" style="width:60px;">' + lang.linkType +
                    '</label>' +
                ...
                dialog = self.createDialog({
                    ...
                    yesBtn: {
                        ...
                        click: function(e) {
                            ...
                            self.exec('createlink', url, typeBox.val()).
                                hideDialog().
                                focus();
                        }
                    }
...
(function(K) {
    ...
    K.extend(KSWFUpload, {
        init: function(options) {
            ...
            var settings = {
                ...
                upload_progress_handler: function(
                    ...
                    progressbar.bar.css('width',
                        Math.round(percent * 80 / 100) + 'px');
        ...
        appendFile: function(file) {
            var self = this;
            var itemDiv = K(
                '<div class="ke-inline-block ke-item" data-id="' + file.id +
                '"></div>');
            ...
            var img = K(
                '<img src="' + file.url + '" class="ke-img" data-status="' +
                file.filestatus + '" width="80" height="80" alt="' + file.name +
                '" />');
            photoDiv.append(img);
    ...
    self.plugin.multiImageDialog = function(options) {
        var clickFn = options.clickFn,
            uploadDesc = K.tmpl(lang.uploadDesc,
                { uploadLimit: imageUploadLimit, sizeLimit: imageSizeLimit });
        var html = [
            '<div style="padding:20px;">',
            '<div class="swfupload">',
            '</div>',
        ...
        var swfupload = K.swfupload({
            ...
            buttonImageUrl: imgPath + (self.langType == 'zh-CN'
...
(function() {
    ...
    SWFUpload.prototype.fileDialogComplete = function(
        numFilesSelected, numFilesQueued, numFilesInQueue) {
    ...
    if (typeof(SWFUpload) === 'function') {
        ...
        SWFUpload.queue.uploadCompleteHandler = function(file) {
            ...
            if (typeof(user_upload_complete_handler) === 'function') {
                continueUpload = (user_upload_complete_handler.call(this,
    ...
    self.plugin.table = {
        prop: function(isInsert) {
            ...
            if (table) {
                ...
                colsBox.val(table[0].rows.length > 0
                    ? table[0].rows[0].cells.length
                    : 0);
                ...
                _setColor(colorBox.eq(1), K.toHex(
                    table[0].style.backgroundColor || table[0].bgColor || ''));
                widthBox[0].focus();
                widthBox[0].select();
            }
        },
    ...
    self.clickToolbar(name, function() {
        ...
        var dialog = self.createDialog({
            ...
            yesBtn: {
                ...
                click: function(e) {
                    var doc = K.iframeDoc(iframe);
                    self[checkbox[0].checked ? 'html' : 'insertHtml'](
                        doc.body.innerHTML).hideDialog().focus();
                }
            }
        });
            ...
            dialog = self.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function(e) {
                        ...
                        str = K.clearMsWord(str, self.filterMode
                            ? self.htmlTags
                            : K.options.htmlTags);
