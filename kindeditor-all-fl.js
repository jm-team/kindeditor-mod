	...
	self.plugin.imageDialog = function(options) {
		...
		var uploadbutton={
			...
			init: function(para){ 
				...
				$('#ke-upload-button .uploadify-button',div).removeClass('uploadify-button');
			},
			submit: function(){
		...
		uploadbutton.init({
	        ...
	        'onUploadSuccess': function(file, data, response){
                ...
                $.getJSON('/getFile?uuid='+obj.fileUUIDs[0],function(rData){
                	var rData = (rData instanceof Object) ? rData : eval('('+rData+')');
                	...
                	if (rData && rData.resultCode == 4){
    					...
    					if (!fillDescAfterUploadImage) {
    						clickFn.call(self, url, rData.originalFileNames.pop()||"", rData.width, rData.height, rData.border, rData.align);
    					} else {
    						K(".ke-dialog-row #remoteUrl", div).val(url);
    						K(".ke-tabs-li", div)[0].click();
    						K(".ke-refresh-btn", div).click();
			...
			upload_success_handler : function(file, serverData) {
				...
				try {
	                ...
	                $.getJSON('/getFile?uuid='+data1.fileUUIDs[0],function(dataStr){
	    				...
	    				if(self.options.fileBasePath) data.url = self.options.fileBasePath+data.url;
	    				file.url = data.url;
